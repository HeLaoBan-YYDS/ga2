...
export default function TermsOfServicePage() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <p>By using this site, you agree not to misuse it, attempt unauthorized access, or present this fan wiki as an official Roblox, Strawberreh Squad, or Grow a Garden 2 property.</p>
    </LegalPage>
  );
}
